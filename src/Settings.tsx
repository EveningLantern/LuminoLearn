...
const Settings = () => {
  ...
  return (
    <div className="min-h-screen pt-24 px-6 pb-6 dark:bg-gray-900 transition-colors duration-200">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6">
          <div className="glass-card p-6 rounded-xl dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Toggle dark mode with blue glow</p>
                </div>
              </div>
              <button
                onClick={toggleDarkMode}
                className={`w-12 h-6 rounded-full transition-colors ${
                  isDarkMode ? 'bg-primary shadow-lg shadow-primary/50' : 'bg-gray-200'
                } relative`}
              >
                <span
          ...
          <div className="glass-card p-6 rounded-xl dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-medium dark:text-white">Reset Account Data</h4>
